...
public class ItemTelaProblema extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Controler.getControler().getQuestaoSelecionadaAmbiente1() != null) {
            GUI.getGui().getItensMetodosAuxiliares().montagemTextView(Controler.getControler().getQuestaoSelecionadaAmbiente1().getProblema(),
                    "Problema: ", t, this);
        }
        else if(Controler.getControler().getQuestaoSelecionadaAmbiente2() != null){
            GUI.getGui().getItensMetodosAuxiliares().montagemTextView(Controler.getControler().getQuestaoSelecionadaAmbiente2().getProblema(),
                    "Problema: ", t, this);
        }
        else{
            GUI.getGui().getItensMetodosAuxiliares().montagemTextView(Controler.getControler().getQuestaoSelecionadaAmbiente3().getProblema(),
                    "Problema: ", t, this);
        }
