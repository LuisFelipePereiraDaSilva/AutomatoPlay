...
public class ItemTelaAjuda extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Controler.getControler().getQuestaoSelecionadaAmbiente1() != null) {
            GUI.getGui().getItensMetodosAuxiliares().montagemTextView(Controler.getControler().getAjudaAmbiente1(), t, this);
        }
        else{
            GUI.getGui().getItensMetodosAuxiliares().montagemTextView(Controler.getControler().getAjudaAmbiente2E3(), t, this);
        }
